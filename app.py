...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://sql10472487:4N3zQgwftd@sql10.freemysqlhosting.net/sql10472487'
...
def seleciona_usuarios():
    ...
    return gera_response_total(200, "usuarios", usuarios_json, usuarios_total)
...
# Atualizar
@app.route("/usuario/<id>", methods=["PUT", "PATCH"])
...
def gera_response_total(status, nome_do_conteudo, conteudo, total, mensagem=False):
    body = {}
    body[nome_do_conteudo] = conteudo
    body["total_registros"] = total
